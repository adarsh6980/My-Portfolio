            ...
            <Reveal delay={0.3}>
              <div className="flex flex-wrap gap-4 pt-2">
                <a
                  ...
                  className="inline-flex h-12 items-center justify-center rounded-full bg-accent-button px-6 text-sm font-bold text-accent-button-foreground transition-transform hover:-translate-y-0.5 hover:bg-accent-button-hover"
                >
                  Download résumé
                </a>
                <a
